              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-admin-card-border">
                    ...
                    <th className="text-left px-6 py-4 text-[0.65rem] font-mono font-semibold text-admin-text-muted uppercase tracking-wider">Département</th>
                    <th className="text-left px-6 py-4 text-[0.65rem] font-mono font-semibold text-admin-text-muted uppercase tracking-wider">Région</th>
                    <th className="text-left px-6 py-4 text-[0.65rem] font-mono font-semibold text-admin-text-muted uppercase tracking-wider">Population</th>
                    <th className="text-left px-6 py-4 text-[0.65rem] font-mono font-semibold text-admin-text-muted uppercase tracking-wider">Slug</th>
                ...
                <tbody className="divide-y divide-admin-card-border">
                  {cities.length > 0 ? (
                    cities.map((city) => (
                      <tr key={city.id} className="hover:bg-admin-hover transition-colors">
                        <td className="px-6 py-4">
                          <span className="text-sm font-medium text-admin-text">{city.name}</span>
                        </td>
                        <td className="px-6 py-4">
                          <span className="text-sm text-admin-text-secondary">{city.department || "-"}</span>
                        </td>
                        <td className="px-6 py-4">
                          <span className="text-sm text-admin-text-secondary">{city.region || "-"}</span>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4">
                          <span className="text-xs text-admin-text-muted font-mono">/{city.slug}</span>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button onClick={() => openEdit(city)} className="p-1.5 rounded-lg hover:bg-admin-hover text-admin-text-muted hover:text-admin-text transition-all">
                              <Pencil size={16} />
                            </button>
                            <button onClick={() => { setSelectedCity(city); setShowDelete(true); }} className="p-1.5 rounded-lg hover:bg-admin-hover text-admin-text-muted hover:text-red-400 transition-all">
                              <Trash2 size={16} />
                            </button>
                          </div>
                        </td>
                      ...
                      <td colSpan={7} className="px-6 py-16 text-center">
                        <div className="flex flex-col items-center gap-3">
                          <div className="w-12 h-12 rounded-2xl bg-admin-input-bg border border-admin-card-border flex items-center justify-center">
                            <MapPin size={24} className="text-admin-text-muted" />
                          </div>
                          <div>
                            <p className="text-admin-text-muted font-medium">Aucune ville trouvée</p>
                            <p className="text-admin-text-muted text-sm mt-1">Créez votre première ville pour le SEO local</p>
                          </div>

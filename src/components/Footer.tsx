...
export default function Footer() {
  return (
    <footer className="bg-dark-2 border-t border-white/[0.04] text-white relative overflow-hidden">
      {/* Subtle glow */}
      ...
      <div className="max-w-[1400px] mx-auto px-5 pt-14 pb-8 lg:px-12 relative z-2">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-[0.8rem] text-white/25 leading-[1.7] max-w-[260px]">
              Agence web creative specialisee en developpement web et solutions digitales sur
              mesure.
            </p>
          ...
          {/* Navigation */}
          <div>
            <h5 className="text-[0.8rem] font-bold mb-4 text-white/40 uppercase tracking-wider">
              Navigation
            </h5>
            <ul className="list-none">
              {links.navigation.map((link) => (
                <li key={link.label} className="mb-2.5">
                  <a
                    href={link.href}
                    className="text-[0.8rem] text-white/25 hover:text-accent transition-colors duration-300"
                  >
                    {link.label}
                  </a>
                </li>
